...
<p align="center">
  <strong>专业的房屋日照计算应用</strong><br>
  精确计算房屋全年各时间段的日照情况，帮助您做出明智的购房决策
</p>
...
entry/src/main/ets/
├── calculator/                     # 评估器核心
│   ├── SimpleSunshineCalculator.ets      # 基础日照评估器
│   ├── AdvancedSunshineCalculator.ets    # 高级日照评估器
│   └── UnitSunshineCalculator.ets        # 单元日照评估器
├── model/                          # 数据模型
│   ├── HouseInputModel.ets               # 房屋输入参数模型
│   ├── HouseSunshineModel.ets            # 日照结果模型
...
├── pages/                          # 页面
│   ├── Index.ets                         # 主页导航
│   ├── SimpleCalculator.ets              # 基础评估器页面
│   ├── AdvancedCalculator.ets            # 高级评估器页面
│   ├── AboutPage.ets                     # 关于页面
